...
class _SettingsPageState extends State<SettingsPage> {
  ...
  // Profile data
  final Map<String, String> profile = {'name': '', 'position': 'Pediatrician'};
                          ...
                          SettingsOption(
                            ...
                            onTap: () {
                              Navigator.push(
                                ...
                                MaterialPageRoute(
                                  builder:
                                      (context) => const SetAvailableTime(),
                                ), // Navigate to Profile page
                              );
                            },
                          ),
      ...
      child: Padding(
        ...
        child: Row(
          children: [
            ...
            Transform.rotate(
              // Correcting the arrow icon orientation
