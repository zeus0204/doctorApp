...
class _DashboardState extends State<Dashboard>
  ...
  List<Map<String, dynamic>> _patients =
      []; // Add this for storing patient info
  ...
  Future<void> getLatestRecordsByDoctorEmail() async {
    ...
    try {
      ...
      List<Map<String, dynamic>> sortedRecentPatients =
  ...
  Future<void> _loadUserData() async {
    try {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
          content: Text('Your profile is lacked, Please login again!'),
        ),
      );
    }
  }
            ...
            final schedules =
                snapshot.docs
                    .map((doc) {
                      ...
                      return Schedule(
                        doctor:
                            patientName, // Using patient name instead of doctor name
                    ...
                    child: ElevatedButton(
                      onPressed: () {
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (context) => ScanQRDashboardPage(),
                          ),
                        );
                      },
