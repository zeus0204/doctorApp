...
class _SignupState extends State<Signup> {
  ...
  Future<void> _submitForm() async {
    ...
    try {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(content: Text("Unexpected error occurred. Try again.")),
      );
    } finally {
      if (mounted) {
        setState(() {
                ...
                children: [
                  ...
                  TextFormField(
                    ...
                    decoration: InputDecoration(
                      ...
                      fillColor:
                          Colors.white, // Background color of the input box
                      filled: true, // This enables the fill color
                    ),
                    style: GoogleFonts.poppins(
                      color: Colors.black,
                    ...
                    obscureText:
                        true, // Makes the input text hidden, for passcode
                  ),
                  const SizedBox(height: 10),
                  TextFormField(
                    validator: (value) {
                  ...
                  SizedBox(
                    ...
                    child: ElevatedButton(
                      style: ElevatedButton.styleFrom(
                        ...
                        padding:
                            EdgeInsets
                                .zero, // Remove the padding to respect the height set by the Container
                      ...
                      Row(
                        ...
                        children: [
                          const Flexible(
                            child: SizedBox(
                              width:
                                  50, // Set the desired width for the left divider
                          ...
                          const Flexible(
                            child: SizedBox(
                              width:
                                  50, // Set the desired width for the right divider
                              child: Divider(color: Colors.grey),
                            ),
                          ),
                        ],
